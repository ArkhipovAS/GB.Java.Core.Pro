...
//        System.out.println(clientList.getSelectionModel().getSelectedItem());
    ...
    private Stage createUpdWindow() {
        Stage stage = null;

        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/upd.fxml"));
            Parent root = fxmlLoader.load();
            stage = new Stage();
            stage.initModality(Modality.APPLICATION_MODAL);

            UpdController updController = fxmlLoader.getController();
            updController.controller = this;
    ...
    public void tryUpdate(String login, String password, String nickname) {
        ...
        System.out.println("сообщение с просьбой смены ника ушла");
    }
    /*Конец смены ника пользователя*/
